    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            for (const item of selectedItems) {
                ...
                if (item.assetId) await client.delete(item.assetId);
            }
